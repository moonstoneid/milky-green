...
class GeneratorSyntax {
    ...
    static Utilities.LineCatalog lineCatalog;
...
//	}
    ...
    private static void logError(int offset, String msg) {
        Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
        if (line == null) {
...
//	}
    ...
    // callback functions
    static class GenFile extends Parser.RuleCallback {
...
//			}
    ...
    static class GenRule extends Parser.RuleCallback {
    ...
    static class NameDef extends Parser.RuleCallback {
    ...
    static class IncAlt extends Parser.RuleCallback {
    ...
    static class Rnm extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length >= 0) {
                ...
                thisOpcode.type = Opcode.Type.RNM;
    ...
    static class Udt extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length >= 0) {
                // create this opcode
                SyntaxOpcode thisOpcode = new SyntaxOpcode();
                thisOpcode.type = Opcode.Type.UDT;
                thisOpcode.index = opcodes.size();
                Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
                thisOpcode.lineno = line.lineno;
    ...
    static class Option extends Parser.RuleCallback {
        ...
        public int preBranch(int offset) {
            // create this opcode
            SyntaxOpcode thisOpcode = new SyntaxOpcode();
            thisOpcode.type = Opcode.Type.REP;
            thisOpcode.index = opcodes.size();
            thisOpcode.min = 0;
            thisOpcode.max = 1;
            Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
    ...
    static class Alternation extends Parser.RuleCallback {
        ...
        public int preBranch(int offset) {
            if (nextAlternativeIsIncremental) {
                ...
                // create this opcode
                SyntaxOpcode thisOpcode = new SyntaxOpcode();
                thisOpcode.type = Opcode.Type.ALT;
                thisOpcode.index = opcodes.size();
                Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
                thisOpcode.lineno = line.lineno;
    ...
    static class Concatenation extends Parser.RuleCallback {
        ...
        public int preBranch(int offset) {
            // create this opcode
            SyntaxOpcode thisOpcode = new SyntaxOpcode();
            thisOpcode.type = Opcode.Type.CAT;
            thisOpcode.index = opcodes.size();
            Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
            thisOpcode.lineno = line.lineno;
    ...
    static class Repetition extends Parser.RuleCallback {
    ...
    static class Rep extends Parser.RuleCallback {
    ...
    static class RepMin extends Parser.RuleCallback {
    ...
    static class RepMax extends Parser.RuleCallback {
    ...
    static class RepMinMax extends Parser.RuleCallback {
    ...
    static class Predicate extends Parser.RuleCallback {
        ...
        public int preBranch(int offset) {
            // create this opcode
            SyntaxOpcode thisOpcode = new SyntaxOpcode();
            thisOpcode.type = Opcode.Type.AND;
            thisOpcode.index = opcodes.size();
            Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
            thisOpcode.lineno = line.lineno;
    ...
    static class And extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length > 0) {
                // get the parent opcode
                SyntaxOpcode parentOpcode = parentStack.peek();
                parentOpcode.type = Opcode.Type.AND;
            }
            return -1;
        }
    }

    static class Not extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length > 0) {
                // get the parent opcode
                SyntaxOpcode parentOpcode = parentStack.peek();
                parentOpcode.type = Opcode.Type.NOT;
            }
            return -1;
        }
    }

    static class ProsVal extends Parser.RuleCallback {
    ...
    static class Tls extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length >= 0) {
                // create this opcode
                SyntaxOpcode thisOpcode = new SyntaxOpcode();
                thisOpcode.type = Opcode.Type.TLS;
                thisOpcode.index = opcodes.size();
                Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
                thisOpcode.lineno = line.lineno;
                // add this opcode to current rule opcode vector
    ...
    static class Tcs extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length >= 0) {
                // create this opcode
                SyntaxOpcode thisOpcode = new SyntaxOpcode();
                thisOpcode.type = Opcode.Type.TBS;
                thisOpcode.index = opcodes.size();
                Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
                thisOpcode.lineno = line.lineno;
                // add this opcode to current rule opcode vector
    ...
    static class Tbs extends Parser.RuleCallback {
    ...
    static class DNum extends Parser.RuleCallback {
    ...
    static class XNum extends Parser.RuleCallback {
    ...
    static class BNum extends Parser.RuleCallback {
    ...
    static class Trg extends Parser.RuleCallback {
        ...
        public int postBranch(int offset, int length) {
            if (length >= 0) {
                // create this opcode
                SyntaxOpcode thisOpcode = new SyntaxOpcode();
                thisOpcode.type = Opcode.Type.TRG;
                thisOpcode.index = opcodes.size();
                Utilities.LineCatalog.Line line = lineCatalog.getLineFromOffset(offset);
                thisOpcode.lineno = line.lineno;
                // add this opcode to current rule opcode vector
