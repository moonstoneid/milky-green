 ...
 * built with APG version 6.1, now obsolete.
 * (See instead <a href="https://sabnf.com">APG Version 7.0</a>.)
...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (inputParam == null
                    || inputParam.isBlank()) {
                throw new Exception("required input file parameter, " + GeneratorCommandLine.Params.INPUT.prefix() + "filename, is missing");
            }
            // working directory
            ...
            Utilities.LineCatalog catalog = new Utilities.LineCatalog(grammarDefinitionFile);
            System.out.println("");
            ...
            parser.setRuleCallback(GeneratorGrammar.RuleNames.FILE.ruleID(), new GeneratorSyntax.GenFile(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.RULE.ruleID(), new GeneratorSyntax.GenRule(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.NAMEDEF.ruleID(), new GeneratorSyntax.NameDef(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.INCALT.ruleID(), new GeneratorSyntax.IncAlt(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.PROSVAL.ruleID(), new GeneratorSyntax.ProsVal(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.ALTERNATION.ruleID(), new GeneratorSyntax.Alternation(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.CONCATENATION.ruleID(), new GeneratorSyntax.Concatenation(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.REPETITION.ruleID(), new GeneratorSyntax.Repetition(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.REP.ruleID(), new GeneratorSyntax.Rep(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.REP_MIN.ruleID(), new GeneratorSyntax.RepMin(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.REP_MAX.ruleID(), new GeneratorSyntax.RepMax(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.REP_MIN_MAX.ruleID(), new GeneratorSyntax.RepMinMax(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.PREDICATE.ruleID(), new GeneratorSyntax.Predicate(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.ANDOP.ruleID(), new GeneratorSyntax.And(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.NOTOP.ruleID(), new GeneratorSyntax.Not(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.OPTION.ruleID(), new GeneratorSyntax.Option(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.RNMOP.ruleID(), new GeneratorSyntax.Rnm(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.UDTOP.ruleID(), new GeneratorSyntax.Udt(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.TLSOP.ruleID(), new GeneratorSyntax.Tls(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.TCSOP.ruleID(), new GeneratorSyntax.Tcs(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.TRGOP.ruleID(), new GeneratorSyntax.Trg(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.TBSOP.ruleID(), new GeneratorSyntax.Tbs(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.DNUM.ruleID(), new GeneratorSyntax.DNum(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.XNUM.ruleID(), new GeneratorSyntax.XNum(parser));
            parser.setRuleCallback(GeneratorGrammar.RuleNames.BNUM.ruleID(), new GeneratorSyntax.BNum(parser));
            ...
            if (cl.flagValues[GeneratorCommandLine.Flags.OPCODES.ordinal()]) {
                ...
                for (GeneratorSyntax.SyntaxRule rule : GeneratorSyntax.rules) {
            ...
            if (cl.flagValues[GeneratorCommandLine.Flags.METRICS.ordinal()]) {
                GeneratorSyntax.SyntaxMetrics mets = GeneratorSyntax.metrics(GeneratorSyntax.rules,
    ...
    private static void displayVersion(PrintStream out) {
        out.println("Java APG Version 1.1.0");
 ...
 * Copyright (c) 2021 Lowell D. Thomas, all rights reserved.
    ...
    private static void generateJava(
            ...
            Vector<GeneratorSyntax.SyntaxRule> rules,
            TreeMap<String, Integer> udtMap,
            Vector<GeneratorSyntax.SyntaxRule> udts,
            Vector<GeneratorSyntax.SyntaxOpcode> opcodes) {
        ...
        while (true) {
            ...
            if (ruleCount > 0) {
                ...
                for (Map.Entry<String, Integer> entry : set) {
                    ...
                    GeneratorSyntax.SyntaxRule rule = rules.elementAt(index);
                    out.print(lineEnd);
                    if (jd != null) {
            ...
            if (udtCount > 0) {
                ...
                for (Map.Entry<String, Integer> entry : set) {
                    String caps = toUpperUnderscore(entry.getKey());
                    int index = entry.getValue();
                    GeneratorSyntax.SyntaxRule udt = udts.elementAt(index);
                    out.print(lineEnd);
                    if (jd != null) {
            ...
            boolean first;
            int ruleNo = 0;
            for (GeneratorSyntax.SyntaxRule rule : rules) {
                ...
                for (int i = rule.opcodeOffset; i < (rule.opcodeOffset + rule.opcodeCount); i++) {
                    GeneratorSyntax.SyntaxOpcode op = opcodes.elementAt(i);
                    switch (op.type) {
                        case ALT:
                            out.print("        {int[] a = {");
                            first = true;
                            for (GeneratorSyntax.SyntaxOpcode child : op.childOpcodes) {
                                if (first) {
                                    first = false;
                                } else {
                                    out.print(",");
                        ...
                        case TLS:
                            ...
                            break;
                        case RNM:
                            GeneratorSyntax.SyntaxRule thisRule = rules.elementAt(op.id);
                            out.print("        op[");
                            out.print(op.index);
