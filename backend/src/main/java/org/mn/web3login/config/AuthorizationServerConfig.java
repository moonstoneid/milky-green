...
public class AuthorizationServerConfig {
    ...
    public OAuth2AuthorizationServerConfigurer<HttpSecurity> authorizationServerConfigurer() {
        OAuth2AuthorizationServerConfigurer<HttpSecurity> authServConfig =
                new OAuth2AuthorizationServerConfigurer<>();
        authServConfig.authorizationEndpoint(authEndpoint -> authEndpoint
                .authorizationRequestConverter(myAuthenticationConverter())
                .consentPage("/oauth2/consent"));
        return authServConfig;
    }

    @Bean
    public MyAuthenticationConverter myAuthenticationConverter() {
