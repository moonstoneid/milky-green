...
abstract class Opcode {
    ...
    void execute(Parser.SystemData data) throws Exception {
     ...
     */
    abstract void executeOpcode(Parser.SystemData data) throws Exception;
    ...
    static final class Alt extends Opcode {
        ...
        void executeOpcode(Parser.SystemData data) throws Exception {
...
//					if(data.stats != null){data.stats.incrementBacktrack(type);} // NOMATCH backtracks over failed child
    ...
    static final class Trg extends Opcode {
        ...
        void executeOpcode(Parser.SystemData data) {
            data.match = false;
            if (data.offset < data.inputString.length) {
