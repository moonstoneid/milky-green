...
public class Utilities {
    ...
    // public API
    /**
     * Generates a string of spaces (<code>0x20</code>) which is often used to
     * provide an indent to a line of text.
     *
    ...
    /**
     * Converts the parser state to a String representation. Used in the
     * formatting of trace and AST displays.
     *
     * @param down if <code>true</code>, the parser direction is "down" the
     * syntax tree -
     * <i>before</i> to parsing the branch below. If <code>false</code>, the
     * direction is "up" <i>after</i> visiting the branch below.
     * @param match if <code>true</code>, the phrase was matched (may be empty)
     * @param length if match is <code>true</code>, the length of the matched
     * phrase. Zero (0) length indicates an empty phrase matched.
     ...
     * Non-printing characters (not in the range <code>32-126</code>) are
     * displayed as hex values (eg. <code>x1F</code>)
     *
     * @param input the character array to convert
     * @param offset offset of the first character in the array subset to
     * convert.
     ...
     * @throws Exception thrown if the named file does not exist or for some
     ...
     * @return the {@link File} object or null if not the file could not
     * be found
     */
    ...
    // XMLWriter
    /**
     * A class for assisting in the writing of XML files. This is an assistant
     * only. Generating a complete and valid XML file is the user's
     * responsibility.
     */
    public static class XMLWriter {
         ...
         *
         * @param indent the number of spaces to indent before printing the
         * line.
         * @param name tag name
         * @param attrs the attributes as name/value pairs of Strings. May be
         * null or an array of zero length if no attributes are to be included
         * in the start tag.
         * @throws Exception thrown if the non-null or non-empty array of
         * attributes does not have an even number of members (name/value pairs)
         */
        public void startTag(int indent, String name, String[] attrs) throws Exception {
            ...
            if (attrs != null && attrs.length > 0) {
                if (attrs.length % 2 != 0) {
                    throw new Exception("attrs.length must be even");
                }
            }
    ...
    // LineCatalog
    /**
     * A class for reading a text file and cataloging its text lines. A catalog
     * record is generated for each text line. The records have information
     * about the line number, the offset to the first character of the line and
     * the line length.
     */
    public static class LineCatalog {
         ...
         * Constructor
         *
         * @param inputString the text whose lines are to be cataloged as a
         * String.
         * @throws IllegalArgumentException thrown if the input string is null
         * or empty.
         */
         ...
         * Constructor
         *
         * @param inputArray the text whose lines are to be cataloged as a
         * character array.
         * @throws IllegalArgumentException thrown if the input string is null
         * or empty.
         */
        ...
        public class Line {
            ...
            /**
             * The number of characters in the line, including the line ending
             * character(s).
             */
            ...
            /**
             * The line end character(s) formatted as "<code>&lt;LF&gt;</code>"
             * for a new line or line feed, "<code>&lt;CRLF&gt;</code>" for a
             * carriage return, line feed pair or "<code>&lt;CR&gt;</code>" for
        ...
        /**
         * Retrieves a single catalog Line for the line containing the requested
         * offset character.
         *
         * @param offset the offset of the first text character to find the line
         * of.
        ...
        public ListIterator<Line> getLineIterator() {
            return lineStore.listIterator();
        }

        /**
         * Clears the catalog of all lines. Clears the list of errors and
         * warnings.
         */
        public void clear() {
            originalChars = null;
