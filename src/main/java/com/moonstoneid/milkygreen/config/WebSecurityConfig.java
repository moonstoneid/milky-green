...
import com.moonstoneid.milkygreen.security.ApiKeyAuthenticationFilter;
import com.moonstoneid.milkygreen.security.Web3AuthenticationFilter;
import com.moonstoneid.milkygreen.security.Web3AuthenticationProvider;
    ...
    public static class ResourceConfig extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            http.requestMatchers()
                    .antMatchers("/css/**", "/img/**", "/js/**", "/favicon.png")
                    .and()
                .authorizeRequests()
